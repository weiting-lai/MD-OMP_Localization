...
% Author    : Weiting Lai
% Version   : -
% Reference : An Iterative Steered Response Power Algorithm for Multi-Source 
% Localization and Counting Using Distributed Microphone Networks 
% (Dang et al., ICCAIS 2023)
% -------------------------------------------------------------
% IR-SRP
...
fprintf('mask‑coverage = %d / %d bins (%.2f %%)\n', ...
        nnz(Wmask), numel(Wmask), 100*nnz(Wmask)/numel(Wmask));
if ~nnz(Wmask), warning('Mask is empty – adjust thresholds.'); end
